# src/rhosocial/activerecord/backend/impl/clickhouse/examples/named_migrations/migrations.py
"""
NamedMigration subclasses for ClickHouse migration examples.
...
class V001CreateUsers(NamedMigration):
    ...
    def up(self, ctx: MigrationContext) -> None:
        ctx.execute(
            "rhosocial.activerecord.backend.impl.clickhouse.examples.named_migrations"
