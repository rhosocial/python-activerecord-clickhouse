# src/rhosocial/activerecord/backend/impl/clickhouse/cli/named_procedure_graph.py
...
Usage:
    $ python -m rhosocial.activerecord.backend.impl.clickhouse named-procedure-graph run \
        myapp.npg.monthly_report \
        --params '{"month": "2026-04"}'

    $ python -m rhosocial.activerecord.backend.impl.clickhouse named-procedure-graph list \
        myapp.npg

    $ python -m rhosocial.activerecord.backend.impl.clickhouse named-procedure-graph validate \
        myapp.npg.monthly_report
"""
