...
class ClickHouseCollation(Enum):
    ...
    # ClickHouse 5.7 and earlier character set collations
    ...
    UCS2_GENERAL_CLICKHOUSE500_CI = "ucs2_general_clickhouse500_ci"
    ...
    UTF8MB3_GENERAL_CLICKHOUSE500_CI = "utf8mb3_general_clickhouse500_ci"
    ...
    # ClickHouse 8.0 language-specific utf8mb4_0900 collations
...
_COLLATION_VALUES = {collation.value for collation in ClickHouseCollation}
_COLLATION_MIN_VERSIONS: Dict[str, Tuple[int, ...]] = {
    collation.value: (8, 0, 0)
    for collation in ClickHouseCollation
...
def validate_clickhouse_collation_name(
    name: str,
    version: Optional[Tuple[int, ...]] = None,
) -> str:
