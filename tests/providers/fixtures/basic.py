...
def create_pydantic_validated_models_table(dialect, table_name: str = "pydantic_validated_models") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition("start_at", ClickHouseDateTime64Type(precision=6)),
            ColumnDefinition("end_at", ClickHouseDateTime64Type(precision=6)),
...
def create_posts_table(dialect, table_name: str = "posts") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition("published_at", ClickHouseDateTime64Type(precision=6)),
            ColumnDefinition("published", BooleanType(),
                constraints=[ColumnConstraint(ColumnConstraintType.DEFAULT, default_value=0)]),
            ColumnDefinition("created_at", ClickHouseDateTime64Type(precision=6)),
            ColumnDefinition("updated_at", ClickHouseDateTime64Type(precision=6)),
        ],
