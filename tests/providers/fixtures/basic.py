...
def create_users_table(dialect, table_name: str = "users") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "username", VarCharType(length=191),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "email", VarCharType(length=191),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
...
def create_type_cases_table(dialect, table_name: str = "type_cases") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        if_not_exists=False,
        columns=[
            ColumnDefinition(dialect, "id", CharType(length=36),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
            ...
            ColumnDefinition(dialect, "email", TextType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "tiny_int", TextType()),
            ColumnDefinition(dialect, "small_int", TextType()),
            ColumnDefinition(dialect, "big_int", TextType()),
            ColumnDefinition(dialect, "float_val", TextType()),
            ColumnDefinition(dialect, "double_val", TextType()),
            ColumnDefinition(dialect, "decimal_val", TextType()),
            ...
            ColumnDefinition(dialect, "blob_val", TextType()),
            ColumnDefinition(dialect, "json_val", TextType()),
            ColumnDefinition(dialect, "array_val", TextType()),
            ColumnDefinition(dialect, "is_active", TextType()),
        ],
        storage_options=dict(_DEFAULT_STORAGE_OPTIONS),
    )
    ...
    return CreateTableExpression(
        ...
        columns=[
            ColumnDefinition(dialect, "id", CharType(length=36),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
                             ColumnConstraint(dialect, ColumnConstraintType.PRIMARY_KEY)]),
            ColumnDefinition(dialect, "string_field", VarCharType(length=255),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
            ...
            ColumnDefinition(dialect, "decimal_field", DoubleType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
                             ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value=10.99)]),
            ColumnDefinition(dialect, "bool_field", TinyIntType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
                             ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value=1)]),
...
def create_validated_field_users_table(dialect, table_name: str = "validated_field_users") -> CreateTableExpression:
    ...
    return CreateTableExpression(
        ...
        columns=[
            ColumnDefinition(dialect, "id", BigIntType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.PRIMARY_KEY)]),
            ColumnDefinition(dialect, "username", VarCharType(length=255),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "email", VarCharType(length=255),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "age", IntegerType()),
            ColumnDefinition(dialect, "balance", DecimalType(precision=10, scale=2)),
            ...
            ColumnDefinition(dialect, "is_active", TinyIntType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
                             ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value=1)]),
        ],
        storage_options=dict(_DEFAULT_STORAGE_OPTIONS),
...
def create_validated_users_table(dialect, table_name: str = "validated_users") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ColumnDefinition(dialect, "id", BigIntType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.PRIMARY_KEY)]),
            ColumnDefinition(dialect, "username", VarCharType(length=50),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "email", VarCharType(length=255),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "age", ClickHouseNullableType(inner_type=IntegerType())),
        ],
        storage_options=dict(_DEFAULT_STORAGE_OPTIONS),
    )
...
def create_pydantic_validated_models_table(dialect, table_name: str = "pydantic_validated_models") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ColumnDefinition(dialect, "id", BigIntType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.PRIMARY_KEY)]),
            ColumnDefinition(dialect, "code", VarCharType(length=32)),
            ...
            ColumnDefinition(dialect, "start_at", ClickHouseDateTime64Type(precision=6)),
            ColumnDefinition(dialect, "end_at", ClickHouseDateTime64Type(precision=6)),
            ColumnDefinition(dialect, "status", VarCharType(length=32)),
            ColumnDefinition(dialect, "normalized_name", VarCharType(length=50)),
            ColumnDefinition(dialect, "created_token", VarCharType(length=255)),
        ],
        storage_options=dict(_DEFAULT_STORAGE_OPTIONS),
    )
...
def create_posts_table(dialect, table_name: str = "posts") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ColumnDefinition(dialect, "id", BigIntType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.PRIMARY_KEY)]),
            ColumnDefinition(dialect, "author", BigIntType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "title", VarCharType(length=255),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "content", TextType()),
            ColumnDefinition(dialect, "published_at", ClickHouseDateTime64Type(precision=6)),
...
def create_comments_table(dialect, table_name: str = "comments") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ColumnDefinition(dialect, "id", BigIntType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.PRIMARY_KEY)]),
            ColumnDefinition(dialect, "post_ref", BigIntType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "author", BigIntType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
...
def create_type_adapter_tests_table(dialect, table_name: str = "type_adapter_tests") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "optional_name", ClickHouseNullableType(inner_type=VarCharType(length=255))),
            ColumnDefinition(dialect, "optional_age", ClickHouseNullableType(inner_type=IntegerType())),
            ColumnDefinition(dialect, "last_login", ClickHouseNullableType(inner_type=TextType())),
            ColumnDefinition(dialect, "is_premium", ClickHouseNullableType(inner_type=BooleanType())),
            ColumnDefinition(dialect, "unsupported_union", VarCharType(length=255)),
            ColumnDefinition(dialect, "custom_bool", VarCharType(length=3)),
            ColumnDefinition(dialect, "optional_custom_bool", ClickHouseNullableType(inner_type=VarCharType(length=3))),
        ],
        storage_options=dict(_DEFAULT_STORAGE_OPTIONS),
    )
...
def create_store_inventory_table(dialect, table_name: str = "store_inventory") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "product_id", IntegerType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "batch_id", VarCharType(length=64),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
