# tests/rhosocial/activerecord_clickhouse_test/feature/basic/test_basic_mapped_models.py
# File path: tests/rhosocial/activerecord_clickhouse_test/feature/basic/test_basic_mapped_models.py
