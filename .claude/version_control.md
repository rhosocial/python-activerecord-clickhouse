...
feat(query): implement window functions for ClickHouse backend
...
| `fix` | Bug fix | `fix: resolve connection leak in ClickHouse backend` |
...
Reason: Feature causes performance regression in ClickHouse 5.7.
Reopens AR-456.
```
...
* b2c3d4e fix: resolve connection timeout in ClickHouse backend
...
dependencies = [
    ...
    "clickhouse-connector-python>=8.0.0",          # Native driver only
]
```
...
- Examples: `rhosocial-activerecord-clickhouse`, `rhosocial-activerecord-mongodb`

**Module Path**: `rhosocial.activerecord.backend.impl.{backend}`

- Examples: `rhosocial.activerecord.backend.impl.clickhouse`
...
# pyproject.toml
[project]
name = "rhosocial-activerecord-clickhouse"
version = "1.2.0"
dependencies = [
    "rhosocial-activerecord>=1.2.0,<2.0.0",
    "clickhouse-connector-python>=8.0.0",
]
...
|-----------------|--------------|----------------|------------|
| 1.2.0           | 1.2.x        | 8.0.0+         | ClickHouse 8.0+ |
| 1.1.5           | 1.1.x        | 8.0.0+         | ClickHouse 5.7+ |
```
...
#### ClickHouse (rhosocial-activerecord-clickhouse)
...
**Driver**: clickhouse-connector-python

**Version Support**: ClickHouse 5.7+, ClickHouse 8.0+ recommended

**Installation**: `pip install rhosocial-activerecord-clickhouse`
