...
<!--
If this change affects other repositories in the rhosocial-activerecord ecosystem (e.g., testsuite, clickhouse, postgres),
...
Also, list any relevant configuration details (e.g., ClickHouse version, Python version).
-->
